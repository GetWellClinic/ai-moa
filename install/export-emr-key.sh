...
# Prompts the user to enter a value for the EMR_SECRET_KEY environment variable.
...
ENV_FILE="$HOME/.config/aimoa/env_emr_key.sh"
BASHRC="$HOME/.bashrc"
LINE='[ -f ~/.config/aimoa/env_emr_key.sh ] && source ~/.config/aimoa/env_emr_key.sh'
