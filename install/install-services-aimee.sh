...
sudo /bin/cp $AIMOA/install/services/ai-moa-incomingfax.service.default $AIMOA/install/services/ai-moa-incomingfax.service
sudo /bin/cp $AIMOA/install/services/ai-moa-incomingfile.service.default $AIMOA/install/services/ai-moa-incomingfile.service
...
sudo /bin/cp $AIMOA/install/services/ai-moa-incomingfax.service /etc/systemd/system/
sudo /bin/cp $AIMOA/install/services/ai-moa-incomingfile.service /etc/systemd/system/
...
sudo /usr/bin/systemctl enable ai-moa-incomingfax.service
sudo /usr/bin/systemctl enable ai-moa-incomingfile.service
...
sudo /usr/sbin/service ai-moa-incomingfax start
sudo /usr/sbin/service ai-moa-incomingfile start
