echo off
REM Startup script for local AI LLM Docker Containers
...
REM Note: Two containers will start, one for Aphrodite LLM container, the other is Caddy which operates the encrypted reverse proxy for SSL/TLS
